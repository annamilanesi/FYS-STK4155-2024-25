...
output_activation_func = sigmoid  # Use a linear activation for output layer (or another appropriate function)
...
mse_train, mse_test = mse_learning_rate_vs_lambda(
    X_train, X_test, z_train, z_test, learning_rates, lambdas, n_epochs=100, neural_network_model=FFNN, batch_size=10
)
...
n_nodes = 10  # Number of nodes in each hidden layer
