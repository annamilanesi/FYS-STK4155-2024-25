...
model = LinearRegression(beta_initial=beta_initial)
...
mse_train_lambda_learningrate, mse_test_lambda_learningrate = model.mse_lambda_vs_learningrate(
    X_train, z_train, X_test, z_test, method='SGD', learning_rate_values=learning_rate_values, lmd_values=lmd_values
)
